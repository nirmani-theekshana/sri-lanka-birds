  ...
  return (
    <div className="bird-card">
      <div className="bird-img-wrapper">
        <img
          src={bird.image_url || 'https://placehold.co/300x200?text=Bird'}
          alt={bird.common_name}
          className="bird-img"
          onError={e => { e.target.src = 'https://placehold.co/300x200?text=Bird'; }}
        />
        <span
      ...
      <div className="bird-info">
        ...
        <p className="bird-desc">
          {bird.description ? bird.description.substring(0, 100) + '...' : ''}
        </p>
      </div>
    </div>
  );
